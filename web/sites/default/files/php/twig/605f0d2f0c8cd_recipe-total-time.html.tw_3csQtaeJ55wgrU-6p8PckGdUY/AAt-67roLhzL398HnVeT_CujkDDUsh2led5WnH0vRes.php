...
/* modules/contrib/recipe/templates/recipe-total-time.html.twig */
class __TwigTemplate_cf2d80988cb11117552742531671894fb6519e20b168eb50d77551bd616c34b2 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 19
        $context["classes"] = [0 => "field", 1 => "field--name-recipe-total-time", 2 => "field--type-integer", 3 => ("field--label-" . $this->sandbox->ensureToStringAllowed(        // line 23
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            echo ">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["total_time"] ?? null), 34, $this->source), "html", null, true);
            echo "</div>
";
        } else {
            // line 36
    ...
    <div";
            ...
            echo ">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["total_time"] ?? null), 38, $this->source), "html", null, true);
            echo "</div>
  </div>
";
        }
    ...
    {
        return "modules/contrib/recipe/templates/recipe-total-time.html.twig";
    }
    ...
    {
        return new Source("", "modules/contrib/recipe/templates/recipe-total-time.html.twig", "/Applications/MAMP/htdocs/blog_food/web/modules/contrib/recipe/templates/recipe-total-time.html.twig");
    }
